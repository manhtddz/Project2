...
import display.form.admin.FormCar;
import display.form.admin.FormCarType;
import display.form.admin.FormClient;
import display.form.admin.FormHome;
import display.form.admin.FormManu;
import display.form.admin.FormOption;
import display.form.admin.FormPolicy;
import display.form.admin.FormReservation;
import display.form.admin.FormUser;
...
//                    setForm(new Form_Tenant());
                    ...
                    dispose(AdminMain.this);
                    Login loginFrame = new Login();
                    loginFrame.setVisible(true);
                }
            }

            private void dispose(AdminMain managerMain) {
                managerMain.dispose();
            }
        });
        setForm(new FormHome());
