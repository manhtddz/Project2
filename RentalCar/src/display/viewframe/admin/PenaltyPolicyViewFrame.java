...
public class PenaltyPolicyViewFrame extends javax.swing.JFrame {

    private PenaltiesPolicy policy = SavePolicyInfo.getCurrentPolicy();

    public PenaltyPolicyViewFrame() {
        initComponents();
        lblNameValue.setText(policy.getName());
        lblPriceValue.setText(Format.getVNCurrency(policy.getPrice()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Penalty Policy Detail");
