...
public class CarAddFrame extends javax.swing.JFrame {
    ...
    public CarAddFrame() {
        ...
        lblMessage.setFont(new Font("sansserif", 1, 12));
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(panelBorder1Layout.createSequentialGroup()
                            ...
                            .addGap(1, 1, 1)))
                    .addComponent(lblValADayPrice, javax.swing.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
                    .addComponent(lblValLatePrice, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(51, 51, 51))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if ("".equals(nameField.getText())
            ...
            if (Validation.validatePrice(priceByDayField.getText())) {
                ...
                lblValADayPrice.setText("Price by day must be numeric and <= 100.000.000.");
            }
            if (Validation.validatePrice(lateReturnPriceField.getText())) {
                ...
                lblValLatePrice.setText("Late return unit price must be numeric and <= 100.000.000.");
            }
            newCar.setStatus(0);
            newCar.setDelFlag(0);
