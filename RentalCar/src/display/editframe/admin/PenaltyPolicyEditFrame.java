...
public class PenaltyPolicyEditFrame extends javax.swing.JFrame {

    private PenaltiesPolicyDAO policyDAO = new PenaltiesPolicyDAO();
    private PenaltiesPolicy policy = SavePolicyInfo.getCurrentPolicy();

    public PenaltyPolicyEditFrame() {
        initComponents();
        nameField.setText(policy.getName());
        priceField.setText(Format.getVNCurrency(policy.getPrice()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Penalty Policy Edit");
        ...
        panelBorder1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 354, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(49, 49, 49))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if ("".equals(nameField.getText())
            ...
            newPolicy.setCreated(policy.getCreated());
            ...
            if (!StringUtils.isEmpty(newPolicy.getName())
                ...
                policyDAO.update(policy.getId(), newPolicy);
                this.dispose();
            }
        }
