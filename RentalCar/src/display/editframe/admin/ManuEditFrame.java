...
public class ManuEditFrame extends javax.swing.JFrame {

    private ManufacturerDAO manuDAO = new ManufacturerDAO();
    private Manufacturers manu = SaveManufacturerInfo.getCurrentManufacturer();

    public ManuEditFrame() {
        initComponents();
        nameField.setText(manu.getName());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manufacturer Edit");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        lblMessage.setText("");
        NewOrUpdateManufacturers newManu = new NewOrUpdateManufacturers();

        newManu.setName(nameField.getText());
        if (!"".equals(nameField.getText())) {
            newManu.setDelFlag(0);
            newManu.setCreated(manu.getCreated());
            manuDAO.update(manu.getId(), newManu);
            this.dispose();
        } else {
